...
## Introduction
This repository has taken definitions outlined in [NumPy's Glossary](https://numpy.org/doc/stable/glossary.html) and put them into a form which can be easily learnt/revised using <a href="https://apps.ankiweb.net/">Anki</a> a cross platform app specifically designed for long term knowledge retention.
...
3. Any updates, translations or corrections to the deck will be available at <a href="https://github.com/darigovresearch/NumPy-Glossary-Flashcards">https://github.com/darigovresearch/NumPy-Glossary-Flashcards</a> so do return periodically to check if you have the latest version.
